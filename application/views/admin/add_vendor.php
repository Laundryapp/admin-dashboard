									...
									<div class="panel with-nav-tabs panel-default">
										<div class="panel-heading">
											<ul id="rowTab" class="nav nav-tabs">
												...
												<li class="active" id="li_1"><a href="javascript:void(0);" data-toggle="tab">Vendor Details</a></li>
												<li id="li_2"><a href="javascript:void(0);" data-toggle="tab">Address Details</a></li>
												<li id="li_3"><a href="javascript:void(0);" data-toggle="tab">Shop Timings</a></li>		
												<li id="li_4"><a href="javascript:void(0);" data-toggle="tab">Holidays List</a></li>	
												<li id="li_5"><a href="javascript:void(0);" data-toggle="tab">Normal & Express Timings</a></li>		
												<li id="li_6"><a href="javascript:void(0);" data-toggle="tab">Shop Pictures</a></li>												
											</ul>
										</div>
											...
											<div class="panel-body">
												...
												<input type="hidden" id="tab7V" name="tab7V" value="1">
															...
															<div class="box-body mandatory_color">
																<div class="col-md-9">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input type="text" class="form-control" id="store_person_email" name="store_person_email" placeholder="Email Address" required >
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input type="text" class="form-control" id="store_phoneid" name="store_phoneid" placeholder="Phone" required > 
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<textarea type="text" class="form-control" id="store_des" name="store_des" placeholder="About" > </textarea></div>
																	</div>	
																</div>
															</div>
															...
															<div class="box-body mandatory_color">	
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input type="text" class="form-control" id="postcode" name="postcode" placeholder="Post Code" onBlur="getPostCodes()">
																...
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input type="text" class="form-control" id="store_latitude" name="store_latitude" placeholder="Latitude" readonly>
																...
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input type="text" class="form-control" id="store_longitude" name="store_longitude" placeholder="Longitude" readonly>
																...
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<textarea class="form-control" id="store_address" name="store_address" placeholder="Address"></textarea>
																...
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input type="text" class="form-control" id="store_location" name="store_location" placeholder="Location">
															...
															<div class="box-body mandatory_color">
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-4">
																			<select class="form-control" name="shop_open_time" id="shop_open_time" onChange="changeTime('shop_open_time','shop_close_time')"><?php echo $timings; ?></select>										
																		</div>
																		<div class="col-sm-4">
																			<select class="form-control" name="shop_close_time" id="shop_close_time" ><?php echo $timingout; ?></select>
																		</div>
																	</div>
																</div>
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-4">
																			<select class="form-control" name="store_sunday_otimings" id="store_sunday_otimings" onChange="changeTime('store_sunday_otimings','store_sunday_ctimings')"><?php echo $timings; ?></select>										
																		</div>
																		<div class="col-sm-4">
																			<select class="form-control" name="store_sunday_ctimings" id="store_sunday_ctimings"><?php echo $timingout; ?></select>
																		</div>
																		<div class="col-sm-4">
																			<input name="isitholiday_sunday" type="checkbox" id="isitholiday_sunday"> Is it Holiday day
																		</div>											
																	</div>
																</div>
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-4">
																			<select class="form-control" name="store_monday_otimings" id="store_monday_otimings" onChange="changeTime('store_monday_otimings','store_monday_ctimings')"><?php echo $timings; ?></select>										
																		</div>
																		<div class="col-sm-4">
																			<select class="form-control" name="store_monday_ctimings" id="store_monday_ctimings"><?php echo $timingout; ?></select>
																		</div>	
																		<div class="col-sm-4">
																			<input name="isitholiday_monday" type="checkbox" id="isitholiday_monday"> Is it Holiday day
																		</div>	
																	</div>
																</div>
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-4">
																			<select class="form-control" name="store_tuesday_otimings" id="store_tuesday_otimings" onChange="changeTime('store_tuesday_otimings','store_tuesday_ctimings')"><?php echo $timings; ?></select>										
																		</div>
																		<div class="col-sm-4">
																			<select class="form-control" name="store_tuesday_ctimings" id="store_tuesday_ctimings"><?php echo $timingout; ?></select>
																		</div>
																		<div class="col-sm-4">
																			<input name="isitholiday_tuesday" type="checkbox" id="isitholiday_tuesday"> Is it Holiday day
																		</div>
																	</div>
																</div>
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-4">
																			<select class="form-control" name="store_wednesday_otimings" id="store_wednesday_otimings" onChange="changeTime('store_wednesday_otimings','store_wednesday_ctimings')"><?php echo $timings; ?></select>										
																		</div>
																		<div class="col-sm-4">
																			<select class="form-control" name="store_wednesday_ctimings" id="store_wednesday_ctimings"><?php echo $timingout; ?></select>
																		</div>
																		<div class="col-sm-4">
																			<input name="isitholiday_wednesday" type="checkbox" id="isitholiday_wednesday"> Is it Holiday day
																		</div>
																	</div>
																</div>
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-4">
																			<select class="form-control" name="store_thrusday_otimings" id="store_thrusday_otimings" onChange="changeTime('store_thrusday_otimings','store_thrusday_ctimings')"><?php echo $timings; ?></select>										
																		</div>
																		<div class="col-sm-4">
																			<select class="form-control" name="store_thrusday_ctimings" id="store_thrusday_ctimings"><?php echo $timingout; ?></select>
																		</div>
																		<div class="col-sm-4">
																			<input name="isitholiday_thrusday" type="checkbox" id="isitholiday_thrusday"> Is it Holiday day
																		</div>			
																	</div>
																</div>
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-4">
																			<select class="form-control" name="store_firday_otimings" id="store_firday_otimings" onChange="changeTime('store_firday_otimings','store_firday_ctimings')"><?php echo $timingout; ?></select>										
																		</div>
																		<div class="col-sm-4">
																			<select class="form-control" name="store_firday_ctimings" id="store_firday_ctimings"><?php echo $timings; ?></select>
																		</div>	
																		<div class="col-sm-4">
																			<input name="isitholiday_firday" type="checkbox" id="isitholiday_firday"> Is it Holiday day
																		</div>		
																	</div>
																</div>
																<div class="col-md-9">
																	<div class="form-group">
																		...
																		<div class="col-sm-4">
																			<select class="form-control" name="store_saturday_otimings" id="store_saturday_otimings" onChange="changeTime('store_saturday_otimings','store_saturday_ctimings')"><?php echo $timingout; ?></select>										
																		</div>
																		<div class="col-sm-4">
																			<select class="form-control" name="store_saturday_ctimings" id="store_saturday_ctimings"><?php echo $timings; ?></select>
																		</div>	
																		<div class="col-sm-4">
																			<input name="isitholiday_saturday" type="checkbox" id="isitholiday_saturday"> Is it Holiday day
																		</div>	
																	</div>
																</div>
															</div>
													...
													<div class="tab-pane fade" id="tabdefault_4">
														...
														<input type="hidden" name="hidHolVal" id="hidHolVal" value= '1' /> 
														<div class="clearfix"></div>
														<div class="box-footer">
													...
													<div class="tab-pane fade" id="tabdefault_5">
														...
														<div class="col-md-9">
															<div class="form-group">
																...
																<div class="col-sm-8">
																	<input type="number" class="form-control" id="normal_pickup_hours" name="normal_pickup_hours" placeholder="Normal Pickup Hours">
															...
															<div class="form-group">
																...
																<div class="col-sm-8">
																	<input type="number" class="form-control" id="normal_delivery_days" name="normal_delivery_days" placeholder="Normal Delivery Days">
															...
															<span id="hideshowNorPec_1">
																<div class="form-group" >
																	<label for="firstname" class="col-sm-4 control-label">Percentage Of Cost</label>
																	<div class="col-sm-6">
																		<input type="number" class="form-control" id="percentage_of_cost" name="percentage_of_cost" placeholder="Percentage of cost">
																	</div>
																</div>
															</span>
															<span id="hideshowNorDefault_1" style="display:none;">
																<div class="form-group" >
																	<label for="firstname" class="col-sm-4 control-label">Default Cost</label>
																	<div class="col-sm-6">
																		<input type="number" class="form-control" id="default_cost" name="default_cost" placeholder="Default cost"></div>
																</div>
															</span>
															...
															<span id="express_pickup_ids">
																<div id="express_addmore_1">
																	<div class="form-group">
																		...
																		<div class="col-sm-6">
																			<input type="number" class="form-control" id="express_minimum_hours_1" name="express_minimum_hours[]" placeholder="Express Pickup Hours"></div>
																		<div class="col-sm-2">				
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-6">
																			<input type="number" class="form-control" id="express_pickup_time_1" name="express_pickup_time[]" placeholder="Delivery hours">
																		</div>
																	</div>
																	<div class="form-group">
																		<label for="" class="col-sm-4 control-label">Type Of Cost</label>
																	...
																	<span id="hideshowPec_1">
																		<div class="form-group" >
																			<label for="firstname" class="col-sm-4 control-label">Percentage Of Cost</label>
																			<div class="col-sm-6">
																				<input type="number" class="form-control" id="express_percentage_of_cost_1" name="express_percentage_of_cost[]" placeholder="Percentage of cost">
																			</div>
																		</div>
																	</span>
																	<span id="hideshowDefault_1" style="display:none;">
																		<div class="form-group" >
																			<label for="firstname" class="col-sm-4 control-label">Default Cost</label>
																			<div class="col-sm-6">
																				<input type="number" class="form-control" id="express_default_cost_1" name="express_default_cost[]" placeholder="Default cost"></div>
																		</div>
																	</span>
																</div>
															</span>
														</div>
														<input type="hidden" name="hidExpressVal" id="hidExpressVal" value= '1' /> 
														<div class="clearfix"></div>
														<div class="box-footer">
													...
													<div class="tab-pane fade" id="tabdefault_6">
														<div class="col-md-9">
															<div class="form-group">
																<label for="" class="col-sm-4 control-label"> Profile Picture <sup style="color:red">*</sup> </label>
																<div class="col-sm-8">
															...
															<div class="form-group">
																<label for="" class="col-sm-4 control-label"> Commercial Picture <sup style="color:red">*</sup> </label>
																<div class="col-sm-8">
														...
														<input type="hidden" name="hid_profile_pic" id="hid_profile_pic" >
														<input type="hidden" name="hid_commercial_pic" id="hid_commercial_pic">
														<div class="clearfix"></div>
														<div class="box-footer">
