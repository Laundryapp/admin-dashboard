                ...
                <div class="ibox-content">
					<form method="POST" action="" enctype="multipart/form-data" id="driver_form" name="driver_form">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="name" type="text" name="name" value="">							
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="email" type="text" name="email" value="">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="postcode" type="text" name="postcode" value="">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<textarea class="mdl-textfield__input form-control" id="address"  name="address" value=""></textarea>
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="mobilenumber" type="number" name="mobilenumber" value="" ></textarea>
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="altermobilenumber" type="number" name="altermobilenumber" value=""></textarea>
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<select class="mdl-textfield__input form-control" id="vehicletype" name="vehicletype" value=""><option value="1">Bike</option><option value="2">Car</option></select>
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="vehiclenum" type="text" name="vehiclenum" value="">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input type="text" class="mdl-textfield__input form-control" id="vehiclemodal"  name="vehiclemodal" value="">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input type="text" class="mdl-textfield__input form-control" id="vehiclecolor"  name="vehiclecolor" value="">
							...
							<div class="col-xs-6">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<div class="col-sm-4">
										<select class="form-control" name="sundaytime" id="sundaytime" ><?php echo $timings; ?></select>										
									</div>
								</div>
							</div> 
							<div class="clearfix"></div> <br>
							...
							<div class="col-xs-6">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<div class="col-sm-4">
										<select class="form-control" name="mondaytime" id="mondaytime" ><?php echo $timings; ?></select>										
									</div>
								</div>
							</div> 
							<div class="clearfix"></div> <br>
							...
							<div class="col-xs-6">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<div class="col-sm-4">
										<select class="form-control" name="tuesdaytime" id="tuesdaytime" ><?php echo $timings; ?></select>										
									</div>
								</div>
							</div> 
							<div class="clearfix"></div> <br>
							...
							<div class="col-xs-6">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<div class="col-sm-4">
										<select class="form-control" name="wednesdaytime" id="wednesdaytime" ><?php echo $timings; ?></select>										
									</div>
								</div>
							</div> 
							<div class="clearfix"></div> <br>
							...
							<div class="col-xs-6">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<div class="col-sm-4">
										<select class="form-control" name="thrusdaytime" id="thrusdaytime" ><?php echo $timings; ?></select>										
									</div>
								</div>
							</div> 
							<div class="clearfix"></div> <br>
							...
							<div class="col-xs-6">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<div class="col-sm-4">
										<select class="form-control" name="fridaytime" id="fridaytime" ><?php echo $timings; ?></select>										
									</div>
								</div>
							</div> 
							<div class="clearfix"></div> <br>
							...
							<div class="col-xs-6">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<div class="col-sm-4">
										<select class="form-control" name="saturdaytime" id="saturdaytime" ><?php echo $timings; ?></select>										
									</div>
								</div>
							</div> 
							<div class="clearfix"></div> <br>
					...
					<span id="error_phonemail" style="color:red"></span>
					<input type="button"  onClick="saveDriverInfo();" value="Add" class="btn btn-success btn-round col-xs-12">
					</div>
